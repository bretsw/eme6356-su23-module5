...
[bretsw.com/eme6356-su23-module5](https://bretsw.com/eme6356-su23-module5)
...
```{r, out.width = "100%", echo = FALSE, fig.align = "center"}
include_graphics("img/5-ex2-7.png")
```
...
```{r, out.width = "100%", echo = FALSE, fig.align = "center"}
include_graphics("img/5-ex2-8.png")
```
...
```{r, out.width = "100%", echo = FALSE, fig.align = "center"}
include_graphics("img/5-ex2-9.png")
```
